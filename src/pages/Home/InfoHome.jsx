...
const InfoHome = () => {
  ...
  return (
    <div className="w-full  border-gray-100 bg-white py-10 px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
      {features.map((item, index) => {
        ...
        return (
          <button
            ...
            className="flex flex-col items-center focus:outline-none border-b-3 border-transparent pb-4
