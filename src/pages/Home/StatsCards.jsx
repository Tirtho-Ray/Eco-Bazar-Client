...
const StatsCards = () => {
  return (
    <div
      className="py-10 bg-cover bg-center mt-32"
      style={{
      ...
      <Container>
        <div className="flex flex-wrap justify-between gap-2">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="h-[174px] w-[300px] bg-white/5 backdrop-blur-md border border-white/20 rounded-xl shadow-lg flex flex-col items-center justify-center"
            >
